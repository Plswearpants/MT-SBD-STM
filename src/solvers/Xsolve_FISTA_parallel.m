function [ Xsol, info ] = Xsolve_FISTA_parallel( Y, A, lambda, mu, varargin )
%XSOLVE_FISTA   Solve for X using FISTA method
%   - Core usage:
%       [ Xsol, info ] = Xsolve_FISTA_parallel( Y, A, lambda, mu, max_iteration )
%
%   - Optional variables:
%       [ ... ] = Xsolve_FISTA_parallel( ... , Xinit, Xpos, getbias )
...
config_path = fullfile(worker_dir, 'Xsolve_config_tunable.mat');
load(config_path);
