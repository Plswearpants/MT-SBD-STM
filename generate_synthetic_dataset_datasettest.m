...
param_ranges.theta_cap = logspace(-5, -3, 6);      % logarithmically spaced
param_ranges.kernel_size = linspace(0.01, 0.16, 6);    % area ratio 
param_ranges.SNR = [10, 3.16, 1];             % [hard, medium, easy]

[param_sets, descriptions] = sample_parameter_space_general(param_ranges);
